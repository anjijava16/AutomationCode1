...
public class MyCourses extends DriverHelper{
     ...
     * @throws Exception
     */
    public MyCourses dataBaseVerificationInUserTable(String emailId,String userName,String phone) throws Exception {
        MyCourses myCourses;
        myCourses = (MyCourses)databaseVerification.dataVerificationInUserTable(MyCourses.class,emailId,userName,phone);
        return myCourses;
    }
    /**
     *  Verify Data in user Table
...
*/
     ...
     * @throws Exception
     */
    public MyCourses dataBaseVerificationInUser_PreOrderTableForINR( String course_id,String course_price,String course_servicetax,String userID) throws Exception {
        MyCourses myCourses;
        myCourses = (MyCourses)databaseVerification.dataVerificationInPreOrderTableForINR(MyCourses.class,course_id,course_price,course_servicetax,userID);
        return myCourses;
    }
     ...
     * @throws Exception
     */
    public MyCourses dataBaseVerificationInUser_PreOrderTableForUSD( String course_id, String course_price,String user_Id1) throws Exception {
        MyCourses myCourses;
        myCourses = (MyCourses)databaseVerification.dataVerificationInPreOrderTableForUSD(MyCourses.class,  course_id,course_price,user_Id1);
        return myCourses;
    }
     ...
     * @throws Exception
     */
    public MyCourses dataBaseVerificationInUser_CoursedTable(String courseId, String isPaidValue, String courseGroup,String UserID) throws Exception {
        MyCourses myCourses;
        myCourses = (MyCourses)databaseVerification.dataVerificationInUser_Course_Table(MyCourses.class,courseId,isPaidValue,courseGroup,UserID);
        return myCourses;
    }
     ...
     * @throws Exception
     */
    public MyCourses dataVerificationInUser_LeadsTable( String courseId, String webSiteAction, String country, String campaignSource, String campaignName, String campaignMedium,String EMAIL) throws Exception {
        MyCourses myCourses;
        myCourses = (MyCourses)databaseVerification.dataVerificationInUserLeadTable(MyCourses.class,courseId,webSiteAction,country,campaignSource,campaignName,campaignMedium,EMAIL);
        return myCourses;
    }
