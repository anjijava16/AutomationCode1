...
public class SingupFromEnrollInListView extends DriverTestCase {
   ...
   //course_Group = adasdasdas
            isPaidValue= propertyReader.readTestData("HomePage_Signup_Is_Paid_Value");
            String getUserID = orderSummaryPage.getUserID(email);
            ...
            orderSummaryPage= orderSummaryPage.dataVerificationInUser_EventTable(course__Id,webSiteAction,campaign_Values, event_Type,getUserID);
            ...
            orderSummaryPage=orderSummaryPage.dataVerificationInUser_PreOrderTableForLeadProcess(course__Id,course_Title,email);
            ...
            allCoursesPage = allCoursesPage.dataVerificationInCompleted_Queue_Jobs_Table(course__Id,email);
