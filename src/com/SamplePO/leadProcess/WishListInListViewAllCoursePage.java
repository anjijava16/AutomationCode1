...
public class WishListInListViewAllCoursePage extends DriverTestCase {
    ...
    public void test025WishListInListViewAllCoursePage() throws Exception {
        ...
        try {
            ...
            allCoursesPage= allCoursesPage.dataVerificationInUser_EventTable(course__Id,webSiteAction,campaign_Values, event_Type,getUserID);
            ...
            this.allCoursesPage = this.allCoursesPage.dataVerificationInCompleted_Queue_Jobs_Table("100",email);
