...
import com.sun.jna.platform.win32.LMJoin.NETSETUP_JOIN_STATUS;
...
@Test 
	public void test_016MakePaymentWhenB1S2OfferIsPresent_RP() throws Exception {
...
@Test (dependsOnMethods= "test_016MakePaymentWhenB1S2OfferIsPresent_RP")
public void test_016MakePaymentWhenB1S2OfferIsPresent_Paypal() throws Exception{
try 
        {
     	    	// Navigate to app url
        	addLog("Navigate to the Edureka application url");
...
@Test(dependsOnMethods ="test_016MakePaymentWhenB1S2OfferIsPresent_Paypal")


public void test_016MakePaymentWhenB1S2OfferIsPresent_CCAvenue() throws Exception{
...
//userName=propertyReader.readRunTimeData("UserName");
 ...
 // DISABLE THE OFFER 
    ...
    TestCase_16_URL = " http://adminqa.edureka.in/admin/offers/offer_edit/5810";
    adminDashboard = adminDashboard.navigateToOfferURL(AdminDashboard.class,TestCase_16_URL);
	...
	dashboardPage = adminDashboard.logout(DashboardPage.class);
			...
			captureScreenshot("test_016MakePaymentWhenB1S2OfferIsPresent_CCAvenue");
			throw e;
		} catch (final Exception e) {
			captureScreenshot("test_016MakePaymentWhenB1S2OfferIsPresent__CCAvenue");
			throw e;
		}
	}
