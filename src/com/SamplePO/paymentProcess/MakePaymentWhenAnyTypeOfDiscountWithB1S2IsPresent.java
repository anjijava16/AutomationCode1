...
public class MakePaymentWhenAnyTypeOfDiscountWithB1S2IsPresent extends DriverTestCase{
	...
	String TestCase_17_B1S2 = "http://adminqa.edureka.in/admin/offers/offer_edit/5678";
	String TestCase_17_Discount = "http://adminqa.edureka.in/admin/offers/offer_edit/5810";
    
	
	@Test 
	public void test_017MakePaymentWhenAnyTypeOfDiscountWithB1S2IsPresent_RP() throws Exception {
...
// Change in the Admin Panel: 
      ...
      // ENALE OFFER       
            // Navigate to B1S2 offer URL 
            adminDashboard = adminDashboard.navigateToOfferURL(AdminDashboard.class,TestCase_17_B1S2);
     ...
     // ENABLE THE DISCOUNT
            ...
            // Navigate to Discount offer URL 
            adminDashboard = adminDashboard.navigateToOfferURL(AdminDashboard.class,TestCase_17_Discount);
...
userHomePage=userHomePage.verifyBanner(banner);*/
	...
	captureScreenshot("test_017MakePaymentWhenAnyTypeOfDiscountWithB1S2IsPresent_RP");
	throw e;
...
@Test (dependsOnMethods= "test_017MakePaymentWhenAnyTypeOfDiscountWithB1S2IsPresent_RP")
public void test_017MakePaymentWhenAnyTypeOfDiscountWithB1S2IsPresent_Paypal() throws Exception{
try 
        {
     	    	// Navigate to app url
        	addLog("Navigate to the Edureka application url");
     ...
     // ENABLE THE DISCOUNT
            //Enalble B1S1 Checkbox
            adminDashboard.enableB1S1Offer();
            // Navigate to Discount offer URL 
            adminDashboard = adminDashboard.navigateToOfferURL(AdminDashboard.class,TestCase_17_Discount);
            // Land on Admin URL page.
            adminDashboard = adminDashboard.activateTheOffer("Active");
...
*/
    ...
    {
     captureScreenshot("test_017MakePaymentWhenAnyTypeOfDiscountWithB1S2IsPresent_Paypal");
     throw e;
    } 
catch (final Exception e) {
    captureScreenshot("test_017MakePaymentWhenAnyTypeOfDiscountWithB1S2IsPresent_Paypal");
...
@Test (dependsOnMethods= "test_017MakePaymentWhenAnyTypeOfDiscountWithB1S2IsPresent_Paypal")
public void test_017MakePaymentWhenAnyTypeOfDiscountWithB1S2IsPresent_CCAvenue() throws Exception{
...
//userName=propertyReader.readRunTimeData("UserName");
	...
	dashboardPage = adminDashboard.logout(DashboardPage.class);
			...
			captureScreenshot("test_017MakePaymentWhenAnyTypeOfDiscountWithB1S2IsPresent_CCAvenue");
			throw e;
		} catch (final Exception e) {
			captureScreenshot("test_017MakePaymentWhenAnyTypeOfDiscountWithB1S2IsPresent__CCAvenue");
			throw e;
		}
	}
}
