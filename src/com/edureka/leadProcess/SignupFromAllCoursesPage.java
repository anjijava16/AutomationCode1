...
public class SignupFromAllCoursesPage extends DriverTestCase{
    ...
    public void test_028SignupFromAllCoursesPage() throws Exception {
        ...
        try {
            ...
            allCoursesPage= allCoursesPage.dataVerificationInUserTable("1",email,username,phone);
            ...
            allCoursesPage= allCoursesPage.dataVerificationInUser_CoursedTable(course__Id,isPaidValue,"",getUserID);

            // Verify Data in User Event Table
            event_Type=propertyReader.readTestData("EventType");
            addLog("Verify Data in User Event Table");
            allCoursesPage= allCoursesPage.dataVerificationInUser_EventTable(course__Id,webSiteAction,campaignName,event_Type,getUserID);
