...
public class VerifyReferralPopupWindow extends DriverTestCase{
    ...
    public void test_006VerifyReferralPopupWindow() throws Exception {
        ...
        try {
            ...
            orderSummaryPage=orderSummaryPage.dataVerificationInUserTable(email,username,phone);
            ...
            String referral_email= propertyReader.readRunTimeData("Email_Id");
            addLog("Database verification for referral popup");
            myProfilePage=myProfilePage.datbaseVerificationFor_ReferralPop(referral_email);
