...
public class MakePaymentWhenAnyTypeOfDiscountNotB1S2 extends DriverTestCase{
	...
	@Test
	public void test_014MakePaymentWhenAnyTypeOfDiscountNotB1S2_RP() throws Exception {
...
*/			
	...
	// DISABLE THE OFFER 
            ...
            TestCase_14_URL = "http://adminqa.edureka.in/admin/offers/offer_edit/5678";
            adminDashboard = adminDashboard.navigateToOfferURL(AdminDashboard.class,TestCase_14_URL);
	...
	captureScreenshot("test_014MakePaymentWhenAnyTypeOfDiscountNotB1S2_RP");
	throw e;
...
@Test (dependsOnMethods="test_014MakePaymentWhenAnyTypeOfDiscountNotB1S2_RP")
public void test_014MakePaymentWhenAnyTypeOfDiscountNotB1S2_Paypal() throws Exception{
try 
        {
     	    	// Navigate to app url
        	addLog("Navigate to the Edureka application url");
...
//Course ID URL 			
			...
			String course_Id= propertyReader.readTestData("Course_ID_BigData");
			//String course_Title= propertyReader.readTestData("BigData_Hadoop_Title");
			String getUserID = selectedCoursePage.getUserID(useremail);
			addLog("Verify Data in Pre-Order table");
...
// DISABLE THE OFFER 
    ...
    {
     captureScreenshot("test_014MakePaymentWhenAnyTypeOfDiscountNotB1S2_Paypal");
     throw e;
    } 
catch (final Exception e) {
    captureScreenshot("test_014MakePaymentWhenAnyTypeOfDiscountNotB1S2_Paypal");
...
@Test(dependsOnMethods= "test_014MakePaymentWhenAnyTypeOfDiscountNotB1S2_Paypal")

	public void test014_MakePaymentWhenAnyTypeOfDiscountNotB1S2_CCAvenue() throws Exception{
...
//userName=propertyReader.readRunTimeData("UserName");
 ...
 // DISABLE THE OFFER 
	...
	dashboardPage = adminDashboard.logout(DashboardPage.class);
			...
			captureScreenshot("test_014MakePaymentWhenAnyTypeOfDiscountNotB1S2_CCAvenue");
			throw e;
		} catch (final Exception e) {
			captureScreenshot("test_014MakePaymentWhenAnyTypeOfDiscountNotB1S2__CCAvenue");
			throw e;
		}
	}
}
