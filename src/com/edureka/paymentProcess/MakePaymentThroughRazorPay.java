...
public class MakePaymentThroughRazorPay extends DriverTestCase{
    ...
    static String course_servicetax = "";
    String getUserID = "";
    @Test
    public void test_006MakePaymentThroughRazorPay() throws Exception {
        ...
        try {
            ...
            String adminemail = propertyReader.readApplicationFile("Admin_UserName");
            String password = propertyReader.readApplicationFile("Admin_Password");
            addLog("Login Application through Admin credentials");
            adminDashboard= signInModalPage.Login_AdminPanel(AdminDashboard.class,adminemail, password);
...
////////////////////////////////////////////////////////////////////////////////////////////
            ...
            course_servicetax = selectedCoursePage.getCourse_ServiceTax();
			...
			String TotalPrice = selectedCoursePage.getCourse_TotalAmount();
			System.out.println("NetPrice : " + TotalPrice);
...
/*            // Verify total Amount for USD is equal to Net price
            ...
            orderSummaryPage=orderSummaryPage.verifyTotalAmount(originalprice, Tax,"","", TotalPrice, Savings);
*/			
...
//Thread.sleep(5000);
            ...
            getUserID = selectedCoursePage.getUserID(email);
            myProfilePage=myProfilePage.dataVerificationInUser_PreOrderTableForINR(course_Id,course_price,course_servicetax,getUserID);
    ...
    //String getUserId = signInModalPage.getUserID(email);
            ...
            myProfilePage=myProfilePage.dataVerificationInUser_PostOrderTable(course_Id,paymentGateway,course_Title,getUserID);
   ...
   //myProfilePage= myProfilePage.dataVerificationInUser_QAUserFavoritesTable(courseId,courseGroup,entityType,getUserID);
