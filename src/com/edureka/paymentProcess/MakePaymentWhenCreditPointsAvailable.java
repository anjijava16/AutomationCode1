...
public class MakePaymentWhenCreditPointsAvailable extends DriverTestCase{
	...
	@Test
	public void test_015MakePaymentWhenCreditPointsAvailable_RP() throws Exception {
	...
	*/			
	...
	@Test(dependsOnMethods= "test_015MakePaymentWhenCreditPointsAvailable_RP")
	public void test_015MakePaymentWhenCreditPointsAvailable_Paypal() throws Exception {		
	try 
			        {
			     	    	// Navigate to app url
			        	addLog("Navigate to the Edureka application url");
			...
			//Course ID URL 			
			    ...
			    {
			     captureScreenshot("test_015_Paypal");
			     throw e;
			    } 
			catch (final Exception e) {
			    captureScreenshot("test_015_Paypal");
...
@Test (dependsOnMethods= "test_015MakePaymentWhenCreditPointsAvailable_Paypal")
	public void test_015MakePaymentWhenCreditPointsAvailable_CCAvenue() throws Exception{
...
try {
    ...
    // Login Application through Admin credentials
    String email = propertyReader.readApplicationFile("Admin_UserName");
    String pass = propertyReader.readApplicationFile("Admin_Password");
    addLog("Login Application through Admin credentials");
    adminDashboard= signInModalPage.Login_AdminPanel(AdminDashboard.class,email, pass);
...
//////////////////////////////////////////////////////////////////////////	
    ...
    razorPayPage=razorPayPage.verifyCCAvenuePage(name, useremail, phone, courseName, courseDate, courseAmount,"");
...
//userName=propertyReader.readRunTimeData("UserName");
 ...
 //////////////////////////////////////////////////////////////  
			...
			captureScreenshot("test_015_CCAvenue");
			throw e;
		} catch (final Exception e) {
			captureScreenshot("test_015__CCAvenue");
			throw e;
		} 
