...
*/
     ...
     */
    @SuppressWarnings("unchecked")
    public <T> T dataVerificationFor_Inquiry(@SuppressWarnings("rawtypes") Class className, String courseId, String webSiteAction, String event_context, String utm_campaign,String courseGroup,String eventType,String level_id,String email,String username) throws Exception {

        Database dbObject = new Database();

/*      String user_Name = propertyReader.readRunTimeData("QueryUserName");
*/      
        String inquiry_Email = email;
...
*/
        String email1 = dbObject.getRecord("users", "email", "first_name", username);
        Assert.assertTrue(email1.contains(inquiry_Email));
     ...
     */   
        ...
        String status1 = dbObject.getRecord("completed_queue_jobs","status" ,new String[]{"event_type","method_name","param2"},new String[]{"eventhubspot","submitHubspotFormCust","%"+inquiry_Email+"%"});
        System.out.println("status: "+status1);

        String Priority = dbObject.getRecord("completed_queue_jobs","priority" ,new String[]{"event_type","method_name","param2"},new String[]{"eventhubspot","submitHubspotFormCust","%"+inquiry_Email+"%"});
    ...
    @SuppressWarnings("unchecked")
    public <T> T dataVerificationForNotification(@SuppressWarnings("rawtypes") Class className, String courseId, String webSiteAction,String emailId) throws Exception {
...
*/
     ...
     */
    @SuppressWarnings("unchecked")
    public <T> T dataVerificationInAmbassadors(@SuppressWarnings("rawtypes") Class className,String UserID) throws Exception {
        Database dbObject = new Database();

        String user_ID = UserID;

        String level_Id = dbObject.getRecord("ambassadors", "level_id", "user_id", user_ID);
        Assert.assertTrue(level_Id.contains("5"));
...
*/
     ...
     */
    @SuppressWarnings("unchecked")
    public <T> T dataVerificationInPostOrderTable(@SuppressWarnings("rawtypes") Class className, String course_id, String paymentGatway, String currency,String user_Id ) throws Exception {
        Database dbObject = new Database();

   /*     String user_Id = dbObject.getRecord("user_leads", "user_id",  new String[]{"email"},  new String[]{emailId});
        Assert.assertTrue((user_Id.equals(UserID)));
   */   //  propertyReader.updatePropertyTestData("User_ID", user_Id);
...
/*        //String serviceTax = propertyReader.readRunTimeData("ServiceTax");
            ...
            Assert.assertTrue(serviceTax_INR.contains());
*/
     ...
     */
    @SuppressWarnings("unchecked")
    public <T> T dataVerificationInPreOrderTableForINR(@SuppressWarnings("rawtypes") Class className, String course_id,String course_price,String course_servicetax,String userID) throws Exception {
        Database dbObject = new Database();

/*        String user_Id = dbObject.getRecord("user_leads", "user_id", new String[]{"email"}, new String[]{emailId});
        Assert.assertTrue((user_Id.equals(userID)));
*/
        String course_Id = dbObject.getRecord("pre_orders", "courseid", "userid",userID);
        Assert.assertTrue(course_Id.contains(course_id));

        String order_Id = dbObject.getRecord("pre_orders", "orderid", "userid",userID);
        Assert.assertTrue(!(order_Id.equals(null)));

        String batch_Id = dbObject.getRecord("pre_orders", "batchid", "userid", userID);
        Assert.assertTrue(!(batch_Id.equals(null)));
...
*/
        //String price = propertyReader.readRunTimeData("PriceValue"); 
        String price_INR = dbObject.getRecord("pre_orders", "priceinr", "userid",userID); 
        System.out.println("Price of the course is : " + course_price);
        System.out.println("DB value of Price of the course is : " + price_INR);
        Assert.assertTrue(price_INR.contains(course_price));
        
        String serviceTax_INR = dbObject.getRecord("pre_orders", "servicetaxinr", new String[]{"courseid", "userid"}, new String[]{course_Id,userID});
        int diff = Integer.parseInt(serviceTax_INR)- Integer.parseInt(course_servicetax);
        if (diff>0 || diff<=3)
        {	
         System.out.println("Value is not Same, But its in permissible limit");
        } 
      
/*	//String serviceTax = propertyReader.readRunTimeData("ServiceTax");
	String serviceTax_INR = dbObject.getRecord("pre_orders", "servicetaxinr", "userid", user_Id);
	System.out.println("Service Tax on the course is : "+ course_servicetax);
	System.out.println("DB value of Price of the course is : " + serviceTax_INR);
	Assert.assertTrue(course_servicetax.contains(serviceTax_INR));
*/
        
        String currency_Id = dbObject.getRecord("pre_orders", "currency_id", "userid", userID);
        Assert.assertTrue(currency_Id.contains("1"));
        return (T) PageFactory.initElements(DriverHelper.driver, className);
    }
     ...
     */
    @SuppressWarnings("unchecked")
    public <T> T dataVerificationInPreOrderTableForUSD(@SuppressWarnings("rawtypes") Class className, String course_id, String course_price,String user_Id1) throws Exception {
        Database dbObject = new Database();

       /* String userId = dbObject.getRecord("user_leads", "user_id", "email", emailId);
        Assert.assertTrue((userId.contains(user_Id1)));
       */ 
        String course_Id = dbObject.getRecord("pre_orders", "courseid", "userid", user_Id1);
        Assert.assertTrue(course_Id.contains(course_id));

        String order_Id = dbObject.getRecord("pre_orders", "orderid", "userid", user_Id1);
        Assert.assertTrue(!(order_Id.equals(null)));

        String batch_Id = dbObject.getRecord("pre_orders", "batchid", "userid", user_Id1);
        Assert.assertTrue(!(batch_Id.equals(null)));

        String price_USD = dbObject.getRecord("pre_orders", "priceusd", "userid",user_Id1); 
        System.out.println("Course Price in USD :" + course_price);
        System.out.println("DB Value of Course Price in USD :" + price_USD);
        Assert.assertTrue(course_price.contains(price_USD));
         
        String serviceTax_INR = dbObject.getRecord("pre_orders", "servicetaxusd", "userid", user_Id1);
        Assert.assertTrue(serviceTax_INR.contains("0"));
        return (T) PageFactory.initElements(DriverHelper.driver, className);
    }
     ...
     */
    @SuppressWarnings("unchecked")
    public <T> T dataVerificationInUser_Course_Table(@SuppressWarnings("rawtypes") Class className, String courseId, String isPaidValue, String courseGroup,String UserID) throws Exception {
...
*/
     ...
     */
    @SuppressWarnings("unchecked")
    public <T> T dataVerificationInUser_Events_Table(@SuppressWarnings("rawtypes") Class className, String courseId, String event_context, String utm_campaign, String event,String UserID) throws Exception {
...
*/
     ...
     */
    @SuppressWarnings("unchecked")
    public <T> T dataVerificationInUserLeadTable(@SuppressWarnings("rawtypes") Class className, String courseId, String webSiteAction, String country, String campaignSource, String campaignName, String campaignMedium,String EMAIL) throws Exception {

        Database dbObject = new Database();
        String emailId1 = EMAIL;

        String zohoLead_Id = dbObject.getRecord("user_leads","zoholead_id",new String[]{"email","course_id"},new String[]{emailId1,courseId});
        Assert.assertTrue(!(zohoLead_Id.equals(null)));

        String user_Id = dbObject.getRecord("user_leads", "user_id",new String[]{"email","course_id"}, new String[]{emailId1,courseId});
        System.out.println("USER ID after new Query: "+ user_Id);
        Assert.assertTrue(!(user_Id.equals(null)));

        String course_Id = dbObject.getRecord("user_leads", "course_id",new String[]{"email","course_id"}, new String[]{emailId1,courseId});
...
/*        String email = dbObject.getRecord("user_leads", "email", "first_name", userName);
        Assert.assertTrue(email.contains(emailId));
*/
        String website_action = dbObject.getRecord("user_leads", "website_action",new String[]{"email","course_id"}, new String[]{emailId1,courseId});
        Assert.assertTrue(website_action.contains(webSiteAction));

        String ip = dbObject.getRecord("user_leads", "user_ip",new String[]{"email","course_id"}, new String[]{emailId1,courseId});
        Assert.assertTrue(!(ip.equals(null)));

        String potential_Id = dbObject.getRecord("user_leads", "zoho_potential_id",new String[]{"email","course_id"}, new String[]{emailId1,courseId});
      //  Assert.assertTrue(!(potential_Id.equals(null)));

        String created = dbObject.getRecord("user_leads", "created",new String[]{"email","course_id"}, new String[]{emailId1,courseId});
        Assert.assertTrue(created.contains(presenttDate()));

        String modified = dbObject.getRecord("user_leads", "modified",new String[]{"email","course_id"}, new String[]{emailId1,courseId});
        Assert.assertTrue(modified.contains(presenttDate()));

        String countryName = dbObject.getRecord("user_leads", "country",new String[]{"email","course_id"}, new String[]{emailId1,courseId});
        Assert.assertTrue(countryName.toLowerCase().contains(country.toLowerCase()));

        String lead_Id = dbObject.getRecord("user_leads", "id",new String[]{"email","course_id"}, new String[]{emailId1,courseId});
...
/*        String campaign_Source = dbObject.getRecord("utm_params", "campaign_source", "lead_id", lead_Id);
     ...
     */
    @SuppressWarnings("unchecked")
    public <T> T dataVerificationInUserTable(@SuppressWarnings("rawtypes") Class className, String custStatus,String EmailID, String Username,String PhoneNum) throws Exception {
        
        Database dbObject = new Database();
        
        String phoneNumber = dbObject.getRecord("users", "mobile", new String[]{"email"}, new String[]{EmailID});
        Assert.assertTrue(phoneNumber.equals(PhoneNum));
        ...
        System.out.println("Logged in Username is: "+user);
...
*/
     ...
     */
    @SuppressWarnings("unchecked")
    public <T> T dataVerificationInUserTable(@SuppressWarnings("rawtypes") Class className,String emailId,String userName,String phone) throws Exception {
     ...
     */
    @SuppressWarnings("unchecked")
    public <T> T dataVerificationInCompleted_Queue_Jobs_Table(@SuppressWarnings("rawtypes") Class className, String courseID,String userEmail) throws Exception {
        ...
        for (int i = 0;i<=4;i++)
        {
         status = dbObject.getRecord("completed_queue_jobs","status" ,new String[]{"event_type","method_name","param2","param2"},new String[]{"eventhubspot","submitHubspotFormCust","%"+userEmail+"%","%"+courseID+"%"});
         System.out.println("status: "+status);

         desc = dbObject.getRecord("completed_queue_jobs","`desc`" ,new String[]{"event_type","method_name","param2","param2"},new String[]{"eventhubspot","submitHubspotFormCust","%"+userEmail+"%","%"+courseID+"%"});
         System.out.println("Priority: "+desc); 
      ...
      Assert.assertTrue(status.contains("3"));
      Assert.assertTrue(desc.contains("Form submissions is sucessful"));
      return (T) PageFactory.initElements(DriverHelper.driver, className);
    }
...
*/
     ...
     */
    @SuppressWarnings("unchecked")
    public <T> T dataVerificationInPreOrderTable(@SuppressWarnings("rawtypes") Class className, String course_Id, String batchTitle,String gateway,String currency,String testCaseName,String sheetName,String Discount,String TotalAmount,String price,String serviceTax,String emailId) throws Exception {
...
/*    String discountplanVal=dbObject.getRecord("pre_orders", "discountplan", new String[]{"courseid", "userid"}, new String[]{course_Id,user_Id});
    if (Discount.equals("null"))
    	Discount="";
    System.out.println("discountplan"+Discount);
    System.out.println("discountplanVal"+discountplanVal);
    Assert.assertTrue(discountplanVal.trim().contains(Discount.trim()));
*/
        //ambassadorflag
...
*/
 ...
 //String totalAmount = propertyReader.readRunTimeData("TotalAmount");
        ...
        Assert.assertTrue(TotalAmount.contains(finalValue));
  //String price = propertyReader.readRunTimeData("PriceValue"); 
        if (currency.equals("USD")) {
            String price_USD = dbObject.getRecord("post_orders", "priceusd", new String[]{"courseid", "userid"}, new String[]{course_Id,user_Id});
            Assert.assertTrue(price_USD.trim().contains(price_USD.trim()));
 ...
 // String serviceTax = propertyReader.readRunTimeData("ServiceTax");
            String serviceTax_INR = dbObject.getRecord("pre_orders", "servicetaxinr", new String[]{"courseid", "userid"}, new String[]{course_Id,user_Id});
            int diff = Integer.parseInt(serviceTax_INR)- Integer.parseInt(serviceTax);
            if (diff>0 || diff<=3)
            {	
             System.out.println("Value is not Same, But its in permissible limit");
            } 
     ...
     */
    @SuppressWarnings("unchecked")
    public <T> T  dataVerificationInUser_QAUserFavoritesTable(@SuppressWarnings("rawtypes") Class className,String courseId,String courseGroup,String entityType,String userId) throws Exception {
        Database dbObject = new Database();
     ...
     */
    @SuppressWarnings("unchecked")
    public <T> T dataVerificationInUser_Events_Table_PaymentType(@SuppressWarnings("rawtypes") Class className,String eventType,String user_ID) throws Exception {
     ...
     */
    @SuppressWarnings("unchecked")
    public <T> T dataVerificationForReferredUserInUserTable(@SuppressWarnings("rawtypes") Class className, String custStatus,String emailId) throws Exception {
...
*/
     ...
     */
    @SuppressWarnings("unchecked")
    public <T> T dataVerificationInPostOrderTables(@SuppressWarnings("rawtypes") Class className, String course_Id, String batchTitle, String paymentGatway, String currency,String emailId) throws Exception {
        Database dbObject = new Database();
     ...
     */
    @SuppressWarnings("unchecked")
    public <T> T dataVerificationInPostOrderOnTheBasisOfPreOrderTable(@SuppressWarnings("rawtypes") Class className, String course_Id, String batchTitle, String paymentGatway, String currency,String emailId) throws Exception {
        Database dbObject = new Database();
     ...
     */
    @SuppressWarnings("unchecked")
    public <T> T dataVerificationInCustomerRecordsTable(@SuppressWarnings("rawtypes") Class className, String course_Id,String courseName,String paymentGatway, String currency,String emailId) throws Exception {
        Database dbObject = new Database();
     ...
     * @throws Exception
     */
    public String getUserId(String emailId) throws Exception{
        Database dbObject = new Database();
        String user_Id = dbObject.getRecord("user_leads", "user_id", "email", emailId);
        return user_Id;
    }
     ...
     */
    @SuppressWarnings("unchecked")
    public <T> T dataVerificationInPreOrderTableForLeadProcess(@SuppressWarnings("rawtypes") Class className, String course_Id, String batchTitle,String emailId) throws Exception {
        Database dbObject = new Database();
...
*/
        ...
        //batch title
        String batch_Title = dbObject.getRecord("pre_orders", "batchtitle", new String[]{"courseid", "userid"}, new String[]{course_Id,user_Id});
       // String courseName = dbObject.getRecord("user_courses","", "", valueToBeMatched)
        System.out.println("Actual batch title:"+batch_Title);
        System.out.println("Expected batch title:"+batchTitle);
       // Assert.assertTrue(batch_Title.contains(batchTitle));
