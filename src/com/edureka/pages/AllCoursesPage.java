...
public class AllCoursesPage extends DriverHelper {
    ...
    public <T> T clickOnAddToWishList(@SuppressWarnings("rawtypes") Class className, String course) {
        ...
        WaitForElementClickable(allGridViewCourses, getTimeOut());
    ...
    public <T> T clickOnAddToWishListNew(@SuppressWarnings("rawtypes") Class className, String courseId) throws InterruptedException {
        ...
        WaitForElementClickable("//div[3]/a/i",getTimeOut());
     ...
     * @throws Exception
     */
    public AllCoursesPage dataVerificationInCompleted_Queue_Jobs_Table( String courseID,String Email) throws Exception {
        AllCoursesPage allCourses;
        allCourses = (AllCoursesPage) databaseVerification.dataVerificationInCompleted_Queue_Jobs_Table(AllCoursesPage.class,courseID,Email);
        return allCourses;
    }
     ...
     * @throws Exception
     */
    public AllCoursesPage dataVerificationInUser_AmbassadorsTable(String UserID) throws Exception {
        AllCoursesPage allCourses;
        allCourses = (AllCoursesPage) databaseVerification.dataVerificationInAmbassadors(AllCoursesPage.class, UserID);
        return allCourses;
    }
     ...
     * @throws Exception
     */
    public AllCoursesPage dataVerificationInUser_CoursedTable(String courseId, String isPaidValue, String courseGroup,String UserID) throws Exception {
        AllCoursesPage allCourses;
        allCourses = (AllCoursesPage) databaseVerification.dataVerificationInUser_Course_Table(AllCoursesPage.class, courseId, isPaidValue, courseGroup,UserID);
        return allCourses;
    }
     ...
     * @throws Exception
     */
    public AllCoursesPage dataVerificationInUser_EventTable(String courseId, String status, String priority, String event_Type,String UserID) throws Exception {
        AllCoursesPage allCourses;
        allCourses = (AllCoursesPage) databaseVerification.dataVerificationInUser_Events_Table(AllCoursesPage.class, courseId, status, priority, event_Type,UserID);
        return allCourses;
    }
     ...
     * @throws Exception
     */
    public AllCoursesPage dataVerificationInUser_LeadsTable(String courseId, String webSiteAction, String country, String campaignSource, String campaignName, String campaignMdedium,String EMAIL) throws Exception {
        AllCoursesPage allCourses;
        allCourses = (AllCoursesPage) databaseVerification.dataVerificationInUserLeadTable(AllCoursesPage.class, courseId, webSiteAction, country, campaignSource, campaignName, campaignMdedium,EMAIL);
        return allCourses;
    }
     ...
     * @throws Exception
     */
    public AllCoursesPage dataVerificationInUserTable(String emailId,String userName,String phone) throws Exception {
        AllCoursesPage allCourses;
        allCourses = (AllCoursesPage) databaseVerification.dataVerificationInUserTable(AllCoursesPage.class,emailId,userName,phone);
        return allCourses;
    }
     ...
     * @throws Exception
     */
    public AllCoursesPage dataVerificationInUserTable(String custID,String Username,String Email,String PhoneNum) throws Exception {
        AllCoursesPage allCourses;
        allCourses = (AllCoursesPage) databaseVerification.dataVerificationInUserTable(AllCoursesPage.class,custID,Username,Email,PhoneNum);
        return allCourses;
    }
     ...
     * @return
     */
    public AllCoursesPage sendQuery(String userName,String email,String phNumber) {
...
*/
     ...
     * @throws Exception
     */
    public AllCoursesPage verifyDataForInquiry(String courseId, String webSiteAction, String event_context, String utm_campaign,String course_Group,String event,String level_id,String email1,String username) throws Exception {
        AllCoursesPage allCourses;
        allCourses = (AllCoursesPage) databaseVerification.dataVerificationFor_Inquiry(AllCoursesPage.class, courseId, webSiteAction, event_context, utm_campaign,course_Group,event,level_id,email1,username);
        return allCourses;
    }
    ...
    public String getUserId(String emailId) throws Exception {
        String user_Id = databaseVerification.getUserId(emailId);
        return user_Id;
    }
